...
elseif ( get_field('layout_type') == 'four' ):	
	...
	<div class="columns-container display-flex">
		...
		<?php while( have_rows('four_column_layout') ): the_row(); ?>
			...
			<?php if( have_rows('left_column_four_first_column') ): ?>
			<?php while( have_rows('left_column_four_first_column') ): the_row(); ?>
			...
			<?php if( have_rows('left_column_four_second_column') ): ?>
			<?php while( have_rows('left_column_four_second_column') ): the_row(); ?>
			...
			<?php if( have_rows('left_column_four_third_column') ): ?>
			<?php while( have_rows('left_column_four_third_column') ): the_row(); ?>
			...
			<?php if( have_rows('left_column_four_fourth_column') ): ?>
			<?php while( have_rows('left_column_four_fourth_column') ): the_row(); ?>
